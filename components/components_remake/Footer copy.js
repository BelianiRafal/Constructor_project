...
export function Footer(lineWidth = '650px', sections, options) {
    ...
    conditions: {
      [types.NEWSLETTER]: {
        value: ({ conditionsTitle, conditionsText }) => {
          return `
        <table class="newsletterContainer" cellspacing="0" cellpadding="0" border="0" align="center" width='${lineWidth}' style='max-width: ${lineWidth}px; width: 100%; background-color: #ffffff;'>
            <tbody>
                <tr>
                    <td>
                        <img loading="lazy" src="https://beliani.info/newsletter/2022/line.jpg" style="display:block; height: 1px;"  alt="">
                    </td>
                </tr>
                <tr>
