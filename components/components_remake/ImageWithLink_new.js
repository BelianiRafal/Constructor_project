...
export const ImageWithLink = isAllowToRender(
  optimize(({ TdAvalign = "top", imgValign = "top", href, src, alt = '', attrs, align = 'center', insideRow, widthPercent = '100' }) => {
    ...
    if (insideRow) {
      return `
				<tr>
					<td width="100%" valign="${TdAvalign}" align="${align}" style="line-height: 0; font-size: 0; padding: 0; margin: 0;">
						<a href="${href}" valign="${TdAvalign}" align="${align}" style="display: block; text-decoration: none; float: ${align};">
    ...
    return `
			<a align="${align}" valign="${TdAvalign}" href="${href}" style="display: block; text-decoration: none;">
