...
export function Footer(sections, options) {
  ...
  const json_footer = {
    ...
    conditions: {
      ...
      [types.LANDINGPAGE]: {
        value: ({ conditionsTitle, conditionsText }) => `
        <table class="newsletterContainer" cellspacing="0" cellpadding="0" border="0" align="center" width='980' style='max-width: 980px; width: 100%' id="newsletter">
            <tbody>
                <tr>
                    <td>
                        <img loading="lazy" src="https://beliani.info/newsletter/2022/line.jpg" style="display:block;max-width: 100%;background-repeat: repeat;width: 100%;"  alt="">
                    </td>
                </tr>
                <tr>
                    <td class="newsletterTopBottomContainer" align="left">
