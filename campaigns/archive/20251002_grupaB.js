...
const categories = [
  // PIERWSZA POMARANCZOWA
  {
    ...
    products: [
      ...
      {
        id: 579271,
        src: getImageUrl('20251002_Pic02c.png', true),
      },

      // PERAI
      {
        id: 423778,
        src: getImageUrl('20251002_Pic03c.png', true),
      },
    ],
  },
  ...
  // DRUGA ZWYKLA Z PARAGRAFEM
  {
    ...
    products: [
      ...
      {
        id: 108480,
        src: getImageUrl('20251002_Pic12c.png', true),
      },

      // NANTON
      {
        id: 584579,
        src: getImageUrl('20251002_Pic13c.png', true),
      },
    ],
  },
  ...
  // TRZECIA POMARANCZOWA
  {
    ...
    products: [
      ...
      {
        id: 97763,
        src: getImageUrl('20251002_Pic23c.png', true),
      },

      // SKARA
      {
        id: 516196,
        src: getImageUrl('20251002_Pic22c.png', true),
      },
    ],
  },
  ...
  // CZWARTA ZWYKLA Z PARAGRAFEM
  {
    ...
    products: [
      ...
      {
        id: 601886,
        src: getImageUrl('20251002_Pic32c.png', true),
      },

      // APAYAO
      {
        id: 581895,
        src: getImageUrl('20251002_Pic33c.png', true),
      },
    ],
  },
];
...
const c20251002_grupaB = new entities.Campaign({
  date: '2025.10.02',
  name: 'Retro | TEST B',
