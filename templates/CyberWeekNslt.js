...
import { Line, Category, Intro, ImageWithLink, Space, OfferPart4za3, TopImageTitle } from "../components/index.js";
...
export async function CyberWeekNslt({
  links,
  getProductById,
  getCategoryLink,
  getCategoryTitle,
  ...
  <table cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 650px; width: 100%; background-color: ${background}; color: #000;" id="newsletter">
        <tbody>
              <tr>
                <td align="center">
                ${Space()}
                ${ (cyber === true && !queries.tit)//Black week gif
                   ? 
                   ImageWithLink({
                                  href: links[0],
                                  src: links[1],
                ...
                ${ (type === "landing" && cyber === true && queries.tit)
                   ? TopImageTitle({
                              href: links[0],
                        ...
                        offerPart.type === "codes"
                          ? OfferPart4za3({
                              ...
                              offerParts: [
                                ...
                                {
                                  code: queries.codeCTA[0],
                                  href: links[0],
                                  type: "newsletter",
                                  color: "#fff",
                                  class: "newsletterCodeCyber",
                                },
                                {
                  ...
                  ${ColumnsTwoPeak({
                    ...
                    left: (computed) => `
                      <td width="50%" style="padding-left:4px">
                        <a href="${getCategoryLink(computed.href)}">
                            <img alt="${getCategoryTitle(computed.name)}" src="${computed.src}" style="max-width: 100%; display:block;" loading="lazy">
                        </a>
                      </td>
                    `,
                    right: (computed) => `
                    ...
                    <tr>
                      <td align="left" class="newsletterBottom20px">
                        ${ImageWithLink({
                          ...
                          alt: "soon ending banners", // Przedostatnia para linków (src)
                        })}
                      </td>
                    </tr>
                    <tr>
                      <td align="left" class="newsletterBottom35px">
                        ${ImageWithLink({
                          ...
                          alt: "soon ending banners", // Ostatnia para linków (src)
                        })}
                      </td>
                    </tr>
                  </tbody>
