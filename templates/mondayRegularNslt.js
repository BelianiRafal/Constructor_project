    ...
    categoriesHTML += `
      <tr>
        <td style="background-color: ${category?.background || background};">
          ${
            (index === 0 && categoryType === 'mondaywithparagraph') || categoryType === "productImg" 
  ...
  <table cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 650px; width: 100%; background-color: ${background}; color: #000;" id="newsletter">
        <tbody>
              ...
              `
                  ...
                  <tr>
                  <td style="background-color: #750000; padding-bottom: 10px;"> </td>
                  </tr>
              <tr>
              ...
              <tr>
                  <td style="background-color: #750000; padding-bottom: 15px;"> </td>
                  </tr>
                <tr>
