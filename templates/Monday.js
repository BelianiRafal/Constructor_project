...
export async function mondayRegularNslt({
  ...
  <table cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="border-collapse: separate; max-width: 650px; width: 100%; background-color: ${background}; color: #000;" id="newsletter">
        <tbody>
              <tr>
                <td align="center">
                  ${
              ...
              <tr>
                <td>
                  <table cellspacing="0" cellpadding="0" style="border-collapse: separate; width: 100%; ">
                    <tbody>
                      <tr>
      ...
      <table align="center" border="0" cellpadding="0" cellspacing="0" class="newsletterContainer" style="border-collapse: separate; margin: 0 auto; max-width: 650px; color: #000000; background-color:#ffffff;" id="newsletter">
          <tbody>
              <tr>
                  <td align="left">
