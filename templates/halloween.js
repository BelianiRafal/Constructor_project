...
export async function halloween({
  links,
  getProductById,
  getCategoryLink,
  getCategoryTitle,
        ...
        <tbody>
              ...
              ${!single_image ? 
                `<tr>
                    <td align="center">
                      ${ImageWithLink({
                        href: links[0],
                        // src: type==='newsletter'?  links[3].replace('image_', 'image_forever_') : links[3],
                        src: links[3],
                      })}
                    </td>
                </tr>`
              ...
              ${
                intro && intro.type != "paragraph"
                  ? `<tr>
                      <td class="newsletterContainer" style="background-color: ${intro.background || background};color:#000000">
                          ${Intro({
                ...
                `<tr>
                    <td style="background-color: ${background};" class="newsletterContainer">
                        ${Create2Columns_Grid({
                            ...
                            `, 
                            shuffle: false, 
                            href: getCategoryLink(' https://www.beliani.ch'), 
