...
import { ImageWithLink, Intro, Line, Timer, TopImageTitle, Space } from '../../components/index.js';
...
export async function TimerOnlyNewsletter({
        ...
        <tbody>
          <tr>
            <td style="padding-top: 0px; padding-left: 0px; padding-right: 0px; text-align: center;">
              ...
              <a href="${links[0]}" style="color:${color || '#000'}; text-decoration: underline;">
  ...
  <tr>
    <td style="background-color: ${timer.background};padding-bottom: 10px;"></td>
  </tr>
  ...
  <tr>
    <td style="background-color: ${timer.background};" class="newsletterBottom20px"></td>
  </tr>
