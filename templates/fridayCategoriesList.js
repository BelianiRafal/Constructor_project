...
export async function fridayCategoriesList({
  links,
  getProductById,
  getCategoryLink,
  getCategoryTitle,
  ...
  <table cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 650px; width: 100%; background-color: ${background}; color: #000;" id="newsletter">
        <tbody>
                ...
                !single_image
                  ? `<tr>
                    <td align="center">
                      ${ImageWithLink({
                        href: links[2],
                        src: ['FR'].includes(country)? "https://pictureserver.net/static/2025/FR_GIF_2025.10.03_FINAL.gif":links[3],
                      })}
                    </td>
                </tr>`
                  : ``
             ...
             <tr><td class='newsletterBottom35px'></td></tr> 
              <tr>
                      <td class="newsletterContainer" style="background-color: ${offerPart.background || background};">
                    ...
                    <tr>
                      <td align="left" class="newsletterBottom35px">
                        ${ImageWithLink({
                          ...
                          alt: 'soon ending banner'// Ostatnia para linków (src)
                        })}
                      </td>
                    </tr>
                  </tbody>
